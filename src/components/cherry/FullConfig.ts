// Removed static import of Cherry. Config relies purely on plain objects now and dynamic init.
...
let customMenuTable: any = null;
let customMenuCodeTheme: any = null;

export const initCustomMenus = (CherryClass: any) => {
    if (customMenuTable && customMenuCodeTheme) return { customMenuTable, customMenuCodeTheme };

    customMenuTable = CherryClass.createMenuHook('图表', {
        iconName: 'trendingUp',
        subMenuConfig: [
            {
                noIcon: true,
    ...
    customMenuCodeTheme = CherryClass.createMenuHook('CodeTheme', {
        iconName: 'checklist',
        subMenuConfig: [
    ...
    return { customMenuTable, customMenuCodeTheme };
};
